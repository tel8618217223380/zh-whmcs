...
$_LANG['affiliatesbullet2'] = "您所推荐的每一个客户在我们网站的账户托管时期的每一笔付款";
...
$_LANG['clientareaheader'] = "欢迎您来到我们的会员中心，在这里您可以浏览或更新个人数据、查询您所购买的主机方案与域名、提交支持单与订购额外的产品和服务。此页展示了任何打开的支持单和未付款账单的简要总览。请确保您的联系信息是最新的。";
...
$_LANG['domainbulksearchintro'] = "批量域名搜索允许您一次搜索最多20个域名。在下面输入域名，每行一个,不要在前面输入WWW.或http://。";
$_LANG['domainbulktransferdescription'] = "您现在可以将已存在的域名转入到我们。开始转入，只需要将域名填在下面，每行一个,不要在前面输入WWW.或http://。";
...
$_LANG['domainemailforwardingdesc'] = "如果电子邮件转发服务器检测到转发地址无效，我们将停用自动转发记录。请检查转发地址，然后您启用一次。对现有转发的任何更改将会在1小时内生效。";
...
$_LANG['flashtutorialsheadertext'] = "这儿是我们的 Flash 教程帮助您完整的使用您的主机空间控制面板。请从下面选择一个任务来详细学习如何完成。";
$_LANG['forwardingtogateway'] = "请稍等，正在跳转到您选择的付款网关...";
...
$_LANG['knowledgebasenoarticles'] = "没有找到相关文章";
...
$_LANG['loginforgotteninstructions'] = "申请密码重置";
$_LANG['loginincorrect'] = "电子邮件地址或者密码不正确，请重试一次。";
$_LANG['loginintrotext'] = "访问此页您必须先登陆，注意：此处的用户名和密码与控制面板的用户名和密码不同。";
...
$_LANG['ordercompletebutnotpaid'] = "注意！您的订购已经完成，但是您还没有付款，所以产品不被会激活。<br />点击下面的链接查看您的账单并付款。";
...
$_LANG['pwresetvalidationsuccessdesc'] = "您的密码已经被重置，新的登陆详情已经发送到了您的邮箱中。";
